...
/**
 * Created by jackie on 2017/10/12 10:09.
 * QQ : 971060378
 * Used as : 关注列表的页面
 */
public class FollowListFragment extends BaseFragment implements BaseRecyclerViewAdapter.OnItemClickListener, OnRefreshListener, OnLoadmoreListener {
    ...
    private void getDataFromNet() {
        OkHttpUtils.post()
                ...
                .addParams(Constant.ACTION, "1")//1 : 为关注列表 2: 粉丝列表
