...
/**
 * Created by jackie on 2017/9/6 17:42.
 * QQ : 971060378
 * Used as : 最热话题
 */
public class MostHotTopicFragment extends BaseFragment implements BaseRecyclerViewAdapter.OnItemClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_most_hot_fragment;
    }
    ...
    private void getDataFromNet() {
        OkHttpUtils.post()
                ...
                .addParams(Constant.TAG, String.valueOf(1))
