...
/**
 * Created by skylar on 2017/12/27 10:42.
 * Used as : 预览编辑所有图片
 */
public class EditAllPhotoFragment extends BaseFragment {
    private String mPhotoPath, mCropPath;
    private int mEditIndex;
    private int key;

    private EditPhotoFragment.OperatorType mCurrentOperatorType;
    ...
    protected void initView(View view) {
        ...
        mCurrentOperatorType = EditPhotoFragment.OperatorType.TYPE_NONE;
        ...
        mosaicView.setOnDrawBmp(new EditPhotoFragment.OnDrawBmp() {
            @Override
        ...
        drawView.setOnDrawBmp(new EditPhotoFragment.OnDrawBmp() {
            @Override
            public void startDraw() {
                showOrHideOtherView(false);
            }
    ...
    private void resetOperatorView() {
        ...
        if (mCurrentOperatorType == EditPhotoFragment.OperatorType.TYPE_NONE || mCurrentOperatorType == EditPhotoFragment.OperatorType.TYPE_CUT) {
            mosaicView.setEnable(false);
            drawView.setEnable(false);
            getView().findViewById(R.id.selectView).setVisibility(View.GONE);
        } else if (mCurrentOperatorType == EditPhotoFragment.OperatorType.TYPE_COMMON_DRAW) {
            mosaicView.setEnable(false);
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.ivDelete:
                ...
                break;
            case R.id.ivCrop:
                mCurrentOperatorType = EditPhotoFragment.OperatorType.TYPE_CUT;
                resetOperatorView();
                ...
                layout.setOnOperatorBmp(new EditPhotoFragment.OnOperatorBmp() {
                    @Override
                ...
                break;
            case R.id.ivMasaike:
                if (mCurrentOperatorType == EditPhotoFragment.OperatorType.TYPE_MOSAIC_DRAW) {
                    mCurrentOperatorType = EditPhotoFragment.OperatorType.TYPE_NONE;
                } else {
                    mCurrentOperatorType = EditPhotoFragment.OperatorType.TYPE_MOSAIC_DRAW;
                }
                resetOperatorView();
                break;
            case R.id.ivPen:
                if (mCurrentOperatorType == EditPhotoFragment.OperatorType.TYPE_COMMON_DRAW) {
                    mCurrentOperatorType = EditPhotoFragment.OperatorType.TYPE_NONE;
                } else {
                    mCurrentOperatorType = EditPhotoFragment.OperatorType.TYPE_COMMON_DRAW;
                }
                resetOperatorView();
                break;
            case R.id.ivUndo:
                ...
                } else if (mCurrentOperatorType == EditPhotoFragment.OperatorType.TYPE_MOSAIC_DRAW) {
