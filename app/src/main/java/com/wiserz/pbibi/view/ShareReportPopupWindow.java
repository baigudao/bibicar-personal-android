 ...
 * Used as : 生成后报价单分享平台的对话框
 */
public class ShareReportPopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public ShareReportPopupWindow(Context context, ShareReportListener listener) {
        super(context);
        setContentView(LayoutInflater.from(context).inflate(R.layout.share_report_popup_window, null));
    ...
    public void dismiss() {
        ...
        fadeAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ShareReportPopupWindow.super.dismiss();
            }
        });
        fadeAnim.start();
    }
