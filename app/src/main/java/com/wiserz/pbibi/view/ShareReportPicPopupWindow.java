 ...
 * Used as : 报价单快照分享平台的对话框
 */
public class ShareReportPicPopupWindow extends PopupWindow implements View.OnClickListener {

    private SharePicReportListener listener;
    protected Context context;

    public interface SharePicReportListener {
    ...
    public ShareReportPicPopupWindow(Context context, SharePicReportListener listener) {
        super(context);
        setContentView(LayoutInflater.from(context).inflate(R.layout.share_report_pic_popup_window, null));
    ...
    public void dismiss() {
        ...
        fadeAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ShareReportPicPopupWindow.super.dismiss();
            }
        });
        fadeAnim.start();
    }
