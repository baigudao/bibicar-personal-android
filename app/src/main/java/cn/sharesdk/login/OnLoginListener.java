...
/**
 * Created by jackie on 2017/8/26 13:28.
 * QQ : 971060378
 * Used as :
 * 第三方登录操作过程中会回调这个接口中的方法，
 * 不同方法衔接第三方登录与用户应用登录/注册的逻辑，
 * 故使用第三方登录时一定要实现本接口的不同方法，
 * 否则第三方登录是没有意义的。
 */
public interface OnLoginListener {
     ...
     * 如果需要注册，则返回true
     */
    boolean onLogin(Platform plat, HashMap<String, Object> res);
    //	/**
